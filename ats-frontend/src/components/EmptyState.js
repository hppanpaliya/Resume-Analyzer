...
const EmptyState = () => {
  return (
    <div className="glass-strong rounded-3xl p-12 text-center hover-glass transition-all duration-300">
      <div className="relative mb-8">
        <div className="w-32 h-32 mx-auto mb-6 relative">
          ...
          {/* Main icon */}
          <div className="absolute inset-8 bg-gradient-to-r from-blue-500 to-purple-500 rounded-full flex items-center justify-center">
      ...
      <div className="grid grid-cols-1 md:grid-cols-3 gap-4 max-w-2xl mx-auto">
        <div className="glass p-4 rounded-2xl">
          ...
          <div className="text-sm text-gray-600 dark:text-gray-300 font-medium">Smart Analysis</div>
        </div>
        ...
        <div className="glass p-4 rounded-2xl">
          ...
          <div className="text-sm text-gray-600 dark:text-gray-300 font-medium">Instant Results</div>
        </div>
        ...
        <div className="glass p-4 rounded-2xl">
          ...
          <div className="text-sm text-gray-600 dark:text-gray-300 font-medium">ATS Friendly</div>
        </div>
      </div>
    </div>
  );
